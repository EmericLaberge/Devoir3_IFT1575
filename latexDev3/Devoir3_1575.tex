...
\begin{tikzpicture}[node distance=1.3cm,auto]
    ...
    \draw[->,color=red] (1) edge[color=red] node[left,color=black] {A} (2);
    \draw[->,color=red] (1) edge[color=red] node[right,color=black] {2} (2);

    \draw[->] (2) edge node[left] {B} (3);
    \draw[->] (2) edge node[right] {14} (3);

    % 2 to 4
    \draw[->,color=red] (2) edge[color=red] node[left,color=black] {C} (4);
    \draw[->,color=red] (2) edge[color=red] node[right,color=black] {14} (4);
    ...
    % 4 to 5 red
    \draw[->,color=red] (4) edge[color=red] node[left,color=black] {D} (5);
    \draw[->,color=red] (4) edge[color=red] node[right,color=black] {3} (5);
    ...
    % 5 to 9 red
    \draw[->,color=red] (5) edge[color=red] node[left,color=black] {E} (9);
    \draw[->,color=red] (5) edge[color=red] node[right,color=black] {70} (9);
    ...
    % 9 to 10 red
    \draw[->,color=red] (9) edge[color=red] node[left,color=black] {M} (10);
    \draw[->,color=red] (9) edge[color=red] node[right,color=black] {1} (10);

    % 10 to 11 red
    \draw[->,color=red] (10) edge[color=red] node[left,color=black] {N} (11);
    \draw[->,color=red] (10) edge[color=red] node[right,color=black] {1} (11);

    % 11 to 12 red
    \draw[->,color=red] (11) edge[color=red] node[left,color=black] {O} (12);
    \draw[->,color=red] (11) edge[color=red] node[right,color=black] {1} (12);
\end {tikzpicture}
\end{center}
...
\begin{tikzpicture}[node distance=1.3cm,auto]
    ...
    \draw[->,color=blue] (1) edge[color=blue] node[left,color=black] {A} (2);
    \draw[->,color=blue] (1) edge[color=blue] node[right,color=black] {2} (2);

    % 2 to 3 color blue
    \draw[->,color=blue] (2) edge[color=blue] node[left,color=black] {B} (3);
    \draw[->,color=blue] (2) edge[color=blue] node[right,color=black] {14} (3);
    ...
    % 3 to 4 dashed 
    \draw[->,dashed,color=blue] (3) edge[color=blue] node[left,color=black] {} (4);
    \draw[->,dashed,color=blue] (3) edge[color=blue] node[right,color=black] {} (4);

    % 4 to 5 blue 
    \draw[->,color=blue] (4) edge[color=blue] node[left,color=black] {D} (5);
    \draw[->,color=blue] (4) edge[color=blue] node[right,color=black] {3} (5);
    ...
    % 5 to 9 blue
    \draw[->,color=blue] (5) edge[color=blue] node[left,color=black] {E} (9);
    \draw[->,color=blue] (5) edge[color=blue] node[right,color=black] {70} (9);
    ...
    % 9 to 10 blue
    \draw[->,color=blue] (9) edge[color=blue] node[left,color=black] {M} (10);
    \draw[->,color=blue] (9) edge[color=blue] node[right,color=black] {1} (10);

    % 10 to 11 blue
    \draw[->,color=blue] (10) edge[color=blue] node[left,color=black] {N} (11);
    \draw[->,color=blue] (10) edge[color=blue] node[right,color=black] {1} (11);

    % 11 to 12 blue
    \draw[->,color=blue] (11) edge[color=blue] node[left,color=black] {O} (12);
    \draw[->,color=blue] (11) edge[color=blue] node[right,color=black] {1} (12);
\end {tikzpicture}
\end{center}
